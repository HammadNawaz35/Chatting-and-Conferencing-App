...
public class com_tech_world_model_realms_MessageRealmProxy extends com.tech.world.model.realms.Message
    implements RealmObjectProxy, com_tech_world_model_realms_MessageRealmProxyInterface {
    ...
    static final class MessageColumnInfo extends ColumnInfo {
        ...
        MessageColumnInfo(OsSchemaInfo schemaInfo) {
            ...
            this.partialTextColKey = addColumnDetails("partialText", "partialText", objectSchemaInfo);
            ...
            this.broadcastUidsColKey = addColumnDetails("broadcastUids", "broadcastUids", objectSchemaInfo);
        ...
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            ...
            dst.partialTextColKey = src.partialTextColKey;
            ...
            dst.broadcastUidsColKey = src.broadcastUidsColKey;
            dst.encryptionTypeColKey = src.encryptionTypeColKey;
            dst.uriColKey = src.uriColKey;
    ...
    private ProxyState<com.tech.world.model.realms.Message> proxyState;
    private RealmList<String> broadcastUidsRealmList;

    com_tech_world_model_realms_MessageRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.tech.world.model.realms.Message>(this);
    ...
    public String realmGet$partialText() {
        proxyState.getRealm$realm().checkIfValid();
        return (java.lang.String) proxyState.getRow$realm().getString(columnInfo.partialTextColKey);
    }

    @Override
    public void realmSet$partialText(String value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            final Row row = proxyState.getRow$realm();
            if (value == null) {
                row.getTable().setNull(columnInfo.partialTextColKey, row.getObjectKey(), true);
                return;
            }
            row.getTable().setString(columnInfo.partialTextColKey, row.getObjectKey(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        if (value == null) {
            proxyState.getRow$realm().setNull(columnInfo.partialTextColKey);
            return;
        }
        proxyState.getRow$realm().setString(columnInfo.partialTextColKey, value);
    }
    ...
    public com.tech.world.model.realms.RealmContact realmGet$contact() {
        ...
        return proxyState.getRealm$realm().get(com.tech.world.model.realms.RealmContact.class, proxyState.getRow$realm().getLink(columnInfo.contactColKey), false, Collections.<String>emptyList());
    }
    ...
    public com.tech.world.model.realms.RealmLocation realmGet$location() {
        ...
        return proxyState.getRealm$realm().get(com.tech.world.model.realms.RealmLocation.class, proxyState.getRow$realm().getLink(columnInfo.locationColKey), false, Collections.<String>emptyList());
    }
    ...
    @Override
    public RealmList<String> realmGet$broadcastUids() {
        proxyState.getRealm$realm().checkIfValid();
        // use the cached value if available
        if (broadcastUidsRealmList != null) {
            return broadcastUidsRealmList;
        } else {
            OsList osList = proxyState.getRow$realm().getValueList(columnInfo.broadcastUidsColKey, RealmFieldType.STRING_LIST);
            broadcastUidsRealmList = new RealmList<java.lang.String>(java.lang.String.class, osList, proxyState.getRealm$realm());
            return broadcastUidsRealmList;
        }
    }

    @Override
    public void realmSet$broadcastUids(RealmList<String> value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            if (proxyState.getExcludeFields$realm().contains("broadcastUids")) {
                return;
            }
        }
    ...
    public String realmGet$uri() {
        proxyState.getRealm$realm().checkIfValid();
        return (java.lang.String) proxyState.getRow$realm().getString(columnInfo.uriColKey);
    }
    ...
    public void realmSet$uri(String value) {
        if (proxyState.isUnderConstruction()) {
            ...
            final Row row = proxyState.getRow$realm();
            if (value == null) {
                row.getTable().setNull(columnInfo.uriColKey, row.getObjectKey(), true);
                return;
            }
            row.getTable().setString(columnInfo.uriColKey, row.getObjectKey(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        if (value == null) {
            proxyState.getRow$realm().setNull(columnInfo.uriColKey);
            return;
        }
        proxyState.getRow$realm().setString(columnInfo.uriColKey, value);
    }
    ...
    public com.tech.world.model.realms.QuotedMessage realmGet$quotedMessage() {
        ...
        return proxyState.getRealm$realm().get(com.tech.world.model.realms.QuotedMessage.class, proxyState.getRow$realm().getLink(columnInfo.quotedMessageColKey), false, Collections.<String>emptyList());
    }
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Message", false, 28, 0);
        ...
        builder.addPersistedProperty("partialText", RealmFieldType.STRING, !Property.PRIMARY_KEY, !Property.INDEXED, !Property.REQUIRED);
        ...
        builder.addPersistedValueListProperty("broadcastUids", RealmFieldType.STRING_LIST, !Property.REQUIRED);
    ...
    @SuppressWarnings("cast")
    public static com.tech.world.model.realms.Message createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        if (json.has("broadcastUids")) {
            excludeFields.add("broadcastUids");
        }
        if (json.has("quotedMessage")) {
            excludeFields.add("quotedMessage");
        }
        com.tech.world.model.realms.Message obj = realm.createObjectInternal(com.tech.world.model.realms.Message.class, true, excludeFields);

        final com_tech_world_model_realms_MessageRealmProxyInterface objProxy = (com_tech_world_model_realms_MessageRealmProxyInterface) obj;
        ...
        if (json.has("partialText")) {
            if (json.isNull("partialText")) {
                objProxy.realmSet$partialText(null);
            } else {
                objProxy.realmSet$partialText((String) json.getString("partialText"));
            }
        }
        ...
        if (json.has("contact")) {
            if (json.isNull("contact")) {
                ...
                com.tech.world.model.realms.RealmContact contactObj = com_tech_world_model_realms_RealmContactRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("contact"), update);
        ...
        if (json.has("location")) {
            if (json.isNull("location")) {
                ...
                com.tech.world.model.realms.RealmLocation locationObj = com_tech_world_model_realms_RealmLocationRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("location"), update);
        ...
        ProxyUtils.setRealmListWithJsonObject(objProxy.realmGet$broadcastUids(), json, "broadcastUids");
        ...
        if (json.has("quotedMessage")) {
            if (json.isNull("quotedMessage")) {
                ...
                com.tech.world.model.realms.QuotedMessage quotedMessageObj = com_tech_world_model_realms_QuotedMessageRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("quotedMessage"), update);
    ...
    public static com.tech.world.model.realms.Message createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.tech.world.model.realms.Message obj = new com.tech.world.model.realms.Message();
        final com_tech_world_model_realms_MessageRealmProxyInterface objProxy = (com_tech_world_model_realms_MessageRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
            ...
            } else if (name.equals("partialText")) {
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$partialText((String) reader.nextString());
                } else {
                    reader.skipValue();
                    objProxy.realmSet$partialText(null);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.tech.world.model.realms.RealmContact contactObj = com_tech_world_model_realms_RealmContactRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$contact(contactObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.tech.world.model.realms.RealmLocation locationObj = com_tech_world_model_realms_RealmLocationRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$location(locationObj);
                }
            ...
            } else if (name.equals("broadcastUids")) {
                objProxy.realmSet$broadcastUids(ProxyUtils.createRealmListWithJsonStream(java.lang.String.class, reader));
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.tech.world.model.realms.QuotedMessage quotedMessageObj = com_tech_world_model_realms_QuotedMessageRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$quotedMessage(quotedMessageObj);
                }
            } else {
                reader.skipValue();
    ...
    static com_tech_world_model_realms_MessageRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.tech.world.model.realms.Message.class), false, Collections.<String>emptyList());
        io.realm.com_tech_world_model_realms_MessageRealmProxy obj = new io.realm.com_tech_world_model_realms_MessageRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.tech.world.model.realms.Message copyOrUpdate(Realm realm, MessageColumnInfo columnInfo, com.tech.world.model.realms.Message object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.tech.world.model.realms.Message) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.tech.world.model.realms.Message copy(Realm realm, MessageColumnInfo columnInfo, com.tech.world.model.realms.Message newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.tech.world.model.realms.Message) cachedRealmObject;
        }

        com_tech_world_model_realms_MessageRealmProxyInterface unmanagedSource = (com_tech_world_model_realms_MessageRealmProxyInterface) newObject;

        Table table = realm.getTable(com.tech.world.model.realms.Message.class);
        ...
        builder.addString(columnInfo.partialTextColKey, unmanagedSource.realmGet$partialText());
        ...
        builder.addStringList(columnInfo.broadcastUidsColKey, unmanagedSource.realmGet$broadcastUids());
        builder.addString(columnInfo.encryptionTypeColKey, unmanagedSource.realmGet$encryptionType());
        builder.addString(columnInfo.uriColKey, unmanagedSource.realmGet$uri());

        // Create the underlying object and cache it before setting any object/objectlist references
        // This will allow us to break any circular dependencies by using the object cache.
        Row row = builder.createNewObject();
        io.realm.com_tech_world_model_realms_MessageRealmProxy managedCopy = newProxyInstance(realm, row);
        cache.put(newObject, managedCopy);

        // Finally add all fields that reference other Realm Objects, either directly or through a list
        com.tech.world.model.realms.RealmContact contactObj = unmanagedSource.realmGet$contact();
        if (contactObj == null) {
            managedCopy.realmSet$contact(null);
        } else {
            com.tech.world.model.realms.RealmContact cachecontact = (com.tech.world.model.realms.RealmContact) cache.get(contactObj);
            if (cachecontact != null) {
                managedCopy.realmSet$contact(cachecontact);
            } else {
                managedCopy.realmSet$contact(com_tech_world_model_realms_RealmContactRealmProxy.copyOrUpdate(realm, (com_tech_world_model_realms_RealmContactRealmProxy.RealmContactColumnInfo) realm.getSchema().getColumnInfo(com.tech.world.model.realms.RealmContact.class), contactObj, update, cache, flags));
            }
        }

        com.tech.world.model.realms.RealmLocation locationObj = unmanagedSource.realmGet$location();
        if (locationObj == null) {
            managedCopy.realmSet$location(null);
        } else {
            com.tech.world.model.realms.RealmLocation cachelocation = (com.tech.world.model.realms.RealmLocation) cache.get(locationObj);
            if (cachelocation != null) {
                managedCopy.realmSet$location(cachelocation);
            } else {
                managedCopy.realmSet$location(com_tech_world_model_realms_RealmLocationRealmProxy.copyOrUpdate(realm, (com_tech_world_model_realms_RealmLocationRealmProxy.RealmLocationColumnInfo) realm.getSchema().getColumnInfo(com.tech.world.model.realms.RealmLocation.class), locationObj, update, cache, flags));
            }
        }

        com.tech.world.model.realms.QuotedMessage quotedMessageObj = unmanagedSource.realmGet$quotedMessage();
        if (quotedMessageObj == null) {
            managedCopy.realmSet$quotedMessage(null);
        } else {
            com.tech.world.model.realms.QuotedMessage cachequotedMessage = (com.tech.world.model.realms.QuotedMessage) cache.get(quotedMessageObj);
            if (cachequotedMessage != null) {
                managedCopy.realmSet$quotedMessage(cachequotedMessage);
            } else {
                managedCopy.realmSet$quotedMessage(com_tech_world_model_realms_QuotedMessageRealmProxy.copyOrUpdate(realm, (com_tech_world_model_realms_QuotedMessageRealmProxy.QuotedMessageColumnInfo) realm.getSchema().getColumnInfo(com.tech.world.model.realms.QuotedMessage.class), quotedMessageObj, update, cache, flags));
            }
        }
    ...
    public static long insert(Realm realm, com.tech.world.model.realms.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.tech.world.model.realms.Message.class);
        long tableNativePtr = table.getNativePtr();
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.tech.world.model.realms.Message.class);
        long objKey = OsObject.createRow(table);
        cache.put(object, objKey);
        String realmGet$messageId = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$messageId();
        if (realmGet$messageId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.messageIdColKey, objKey, realmGet$messageId, false);
        }
        String realmGet$fromId = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$fromId();
        if (realmGet$fromId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fromIdColKey, objKey, realmGet$fromId, false);
        }
        String realmGet$fromPhone = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$fromPhone();
        ...
        String realmGet$toId = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$toId();
        if (realmGet$toId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.toIdColKey, objKey, realmGet$toId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.typeColKey, objKey, ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$type(), false);
        String realmGet$content = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$content();
        if (realmGet$content != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.contentColKey, objKey, realmGet$content, false);
        }
        String realmGet$partialText = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$partialText();
        if (realmGet$partialText != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.partialTextColKey, objKey, realmGet$partialText, false);
        }
        String realmGet$timestamp = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$timestamp();
        if (realmGet$timestamp != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.timestampColKey, objKey, realmGet$timestamp, false);
        }
        String realmGet$chatId = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$chatId();
        if (realmGet$chatId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.chatIdColKey, objKey, realmGet$chatId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.messageStatColKey, objKey, ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$messageStat(), false);
        String realmGet$localPath = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$localPath();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.downloadUploadStatColKey, objKey, ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$downloadUploadStat(), false);
        String realmGet$metadata = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$metadata();
        if (realmGet$metadata != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.metadataColKey, objKey, realmGet$metadata, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.voiceMessageSeenColKey, objKey, ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$voiceMessageSeen(), false);
        String realmGet$mediaDuration = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$mediaDuration();
        ...
        String realmGet$thumb = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$thumb();
        if (realmGet$thumb != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.thumbColKey, objKey, realmGet$thumb, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isForwardedColKey, objKey, ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$isForwarded(), false);
        String realmGet$videoThumb = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$videoThumb();
        ...
        String realmGet$fileSize = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$fileSize();
        if (realmGet$fileSize != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fileSizeColKey, objKey, realmGet$fileSize, false);
        }

        com.tech.world.model.realms.RealmContact contactObj = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$contact();
        if (contactObj != null) {
            Long cachecontact = cache.get(contactObj);
            if (cachecontact == null) {
                cachecontact = com_tech_world_model_realms_RealmContactRealmProxy.insert(realm, contactObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.contactColKey, objKey, cachecontact, false);
        }

        com.tech.world.model.realms.RealmLocation locationObj = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$location();
        if (locationObj != null) {
            Long cachelocation = cache.get(locationObj);
            if (cachelocation == null) {
                cachelocation = com_tech_world_model_realms_RealmLocationRealmProxy.insert(realm, locationObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.locationColKey, objKey, cachelocation, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isGroupColKey, objKey, ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$isGroup(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isBroadcastColKey, objKey, ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$isBroadcast(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isSeenColKey, objKey, ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$isSeen(), false);

        RealmList<java.lang.String> broadcastUidsList = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$broadcastUids();
        if (broadcastUidsList != null) {
            OsList broadcastUidsOsList = new OsList(table.getUncheckedRow(objKey), columnInfo.broadcastUidsColKey);
            for (java.lang.String broadcastUidsItem : broadcastUidsList) {
                if (broadcastUidsItem == null) {
                    broadcastUidsOsList.addNull();
                } else {
                    broadcastUidsOsList.addString(broadcastUidsItem);
                }
            }
        }
        String realmGet$encryptionType = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$encryptionType();
        ...
        String realmGet$uri = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$uri();
        if (realmGet$uri != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.uriColKey, objKey, realmGet$uri, false);
        }

        com.tech.world.model.realms.QuotedMessage quotedMessageObj = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$quotedMessage();
        if (quotedMessageObj != null) {
            Long cachequotedMessage = cache.get(quotedMessageObj);
            if (cachequotedMessage == null) {
                cachequotedMessage = com_tech_world_model_realms_QuotedMessageRealmProxy.insert(realm, quotedMessageObj, cache);
            }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.tech.world.model.realms.Message.class);
        com.tech.world.model.realms.Message object = null;
        while (objects.hasNext()) {
            object = (com.tech.world.model.realms.Message) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.tech.world.model.realms.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && !RealmObject.isFrozen(object) && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getObjectKey();
        }
        Table table = realm.getTable(com.tech.world.model.realms.Message.class);
        ...
        if (realmGet$partialText != null) {
            ...
            Table.nativeSetNull(tableNativePtr, columnInfo.partialTextColKey, objKey, false);
        }
        String realmGet$timestamp = ((com_tech_world_model_realms_MessageRealmProxyInterface) object).realmGet$timestamp();
        if (realmGet$timestamp != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.timestampColKey, objKey, realmGet$timestamp, false);
        ...
        if (contactObj != null) {
            Long cachecontact = cache.get(contactObj);
            if (cachecontact == null) {
                cachecontact = com_tech_world_model_realms_RealmContactRealmProxy.insertOrUpdate(realm, contactObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.contactColKey, objKey, cachecontact, false);
        } else {
        ...
        if (locationObj != null) {
            Long cachelocation = cache.get(locationObj);
            if (cachelocation == null) {
                cachelocation = com_tech_world_model_realms_RealmLocationRealmProxy.insertOrUpdate(realm, locationObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.locationColKey, objKey, cachelocation, false);
        } else {
        ...
        if (realmGet$uri != null) {
            ...
            Table.nativeSetNull(tableNativePtr, columnInfo.uriColKey, objKey, false);
        }
        ...
        if (quotedMessageObj != null) {
            Long cachequotedMessage = cache.get(quotedMessageObj);
            if (cachequotedMessage == null) {
                cachequotedMessage = com_tech_world_model_realms_QuotedMessageRealmProxy.insertOrUpdate(realm, quotedMessageObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.quotedMessageColKey, objKey, cachequotedMessage, false);
        } else {
    ...
    public static com.tech.world.model.realms.Message createDetachedCopy(com.tech.world.model.realms.Message realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.tech.world.model.realms.Message unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.tech.world.model.realms.Message();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.tech.world.model.realms.Message) cachedObject.object;
            }
            unmanagedObject = (com.tech.world.model.realms.Message) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_tech_world_model_realms_MessageRealmProxyInterface unmanagedCopy = (com_tech_world_model_realms_MessageRealmProxyInterface) unmanagedObject;
        com_tech_world_model_realms_MessageRealmProxyInterface realmSource = (com_tech_world_model_realms_MessageRealmProxyInterface) realmObject;
        ...
        unmanagedCopy.realmSet$partialText(realmSource.realmGet$partialText());
        ...
        unmanagedCopy.realmSet$contact(com_tech_world_model_realms_RealmContactRealmProxy.createDetachedCopy(realmSource.realmGet$contact(), currentDepth + 1, maxDepth, cache));

        // Deep copy of location
        unmanagedCopy.realmSet$location(com_tech_world_model_realms_RealmLocationRealmProxy.createDetachedCopy(realmSource.realmGet$location(), currentDepth + 1, maxDepth, cache));
        ...
        unmanagedCopy.realmSet$broadcastUids(new RealmList<java.lang.String>());
        unmanagedCopy.realmGet$broadcastUids().addAll(realmSource.realmGet$broadcastUids());
        ...
        unmanagedCopy.realmSet$quotedMessage(com_tech_world_model_realms_QuotedMessageRealmProxy.createDetachedCopy(realmSource.realmGet$quotedMessage(), currentDepth + 1, maxDepth, cache));
