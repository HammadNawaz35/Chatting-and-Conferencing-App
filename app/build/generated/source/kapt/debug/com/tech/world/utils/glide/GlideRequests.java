package com.tech.world.utils.glide;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.tech.world.utils.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.tech.world.utils.glide.GlideOptions().apply(toSet));
    }
  }
}
