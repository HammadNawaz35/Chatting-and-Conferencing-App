...
import com.tech.world.activities.calling.model.CallType
import com.tech.world.activities.calling.model.CallingState
import com.tech.world.activities.calling.model.EngineConfig
import com.tech.world.common.extensions.unBindServiceSafely
import com.tech.world.extensions.finishAndRemoveTaskCompat
import com.tech.world.model.ImageItem
...
import com.tech.world.utils.network.FireManager.Companion.checkAndDownloadUserPhoto
import com.tech.world.utils.network.FireManager.Companion.fetchUserByUid
...
class CallingActivity : BaseActivity(), ServiceConnection {
    ...
    private fun getCallTypeText(): String {
        return when (callType) {
            CallType.VIDEO -> getString(R.string.fireapp_video_call)
            CallType.CONFERENCE_VIDEO -> getString(R.string.fireapp_conference_video_call)
            CallType.CONFERENCE_VOICE -> getString(R.string.fireapp_conference_voice_call)
            else -> getString(R.string.fireapp_voice_call)
        }
    }
