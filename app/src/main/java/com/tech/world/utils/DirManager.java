...
public class DirManager {
    ...
    //the sent stickers : /sdcard/FireApp/FireAppStickers/Sent
    ...
    public static File generateFile(int type) {
        ...
        switch (type) {
            ...
            case MessageType.SENT_STICKER:
                file = new File(getSentStickersFolder() + "/" + generateNewName(type) + EXTENSION_PNG);
                break;


            case MessageType.RECEIVED_STICKER:
                file = new File(getReceivedStickersFolder() + "/" + generateNewName(type) + EXTENSION_PNG);
                break;
    ...
    public static String getRelativePath(int type) {
        switch (type) {
            case MessageType.RECEIVED_IMAGE:
                return APP_FOLDER_NAME + "/" + APP_FOLDER_NAME + "Images";

            case MessageType.RECEIVED_VIDEO:
                return APP_FOLDER_NAME + "/" + APP_FOLDER_NAME + "Video";

            case MessageType.RECEIVED_AUDIO:
                return APP_FOLDER_NAME + "/" + APP_FOLDER_NAME + "Audio";

            default:
                return APP_FOLDER_NAME + "/" + APP_FOLDER_NAME + "Files";
        }
    }
