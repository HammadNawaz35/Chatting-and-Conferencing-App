...
import com.tech.world.BuildConfig;
...
public class IntentUtils {
    ...
    public static final String EXTRA_PICKED_BACKUP = "EXTRA_PICKED_BACKUP";
    public static final String EXTRA_DB_FILE_URI = "EXTRA_DB_FILE_URI";
    ...
    public static final String ACTION_START_BACKUP = "action-start-backup";
    public static final String ACTION_CANCEL_BACKUP = "action-cancel-backup";
    public static final String INTENT_EXTRA_BACKUP_TYPE = "extra-backup-type";
