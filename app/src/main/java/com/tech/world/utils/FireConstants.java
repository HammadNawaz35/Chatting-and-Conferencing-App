...
public class FireConstants {
    ...
    public static final DatabaseReference pkPwd = mainRef.child("pkPwd");


    public static final DatabaseReference updateRef = mainRef.child("updateMode").child("android");

    public static final DatabaseReference deviceIdRef = mainRef.child("deviceId");
    ...
    public static final StorageReference stickersRef = storageRef.child("stickers");
