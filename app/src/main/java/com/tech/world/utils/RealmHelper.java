...
import com.tech.world.model.realms.TempMessage;
import com.tech.world.events.GroupActiveStateChanged;
import com.tech.world.model.constants.DBConstants;
import com.tech.world.model.constants.DownloadUploadStat;
import com.tech.world.model.constants.FireCallDirection;
import com.tech.world.model.constants.MessageStat;
import com.tech.world.model.constants.MessageType;
import com.tech.world.model.realms.Broadcast;
import com.tech.world.model.realms.Chat;
import com.tech.world.model.realms.CurrentUserInfo;
import com.tech.world.model.realms.DeletedMessage;
import com.tech.world.model.realms.FireCall;
import com.tech.world.model.realms.Group;
import com.tech.world.model.realms.JobId;
import com.tech.world.model.realms.Message;
import com.tech.world.model.realms.PendingGroupJob;
import com.tech.world.model.realms.Status;
import com.tech.world.model.realms.StatusSeenBy;
import com.tech.world.model.realms.UnUpdatedStat;
import com.tech.world.model.realms.UnUpdatedVoiceMessageStat;
import com.tech.world.model.realms.User;
import com.tech.world.model.realms.UserStatuses;
...
public class RealmHelper {
    ...
    public void saveObjectToRealm(RealmObject object) {
        ...
        if (object instanceof Message || object instanceof TempMessage)
    ...
    public void deleteTempMessage(String messageId) {
        RealmResults<TempMessage> tempMessages = realm.where(TempMessage.class).equalTo(DBConstants.MESSAGE_ID, messageId).findAll();
        realm.executeTransaction(realm -> {
            tempMessages.deleteAllFromRealm();
        });
    }
    ...
    //get certain message
    public TempMessage getTempMessage(String id) {
        return realm.where(TempMessage.class).equalTo(DBConstants.MESSAGE_ID, id).findFirst();
    }
    ...
    public boolean shouldDeleteAfterLogin(String newUid) {
        CurrentUserInfo currentUserInfo = realm.where(CurrentUserInfo.class).findFirst();
        return currentUserInfo != null && !currentUserInfo.getUid().equals(newUid);
    }
...
*/
    ...
    public void setMessageUri(@NotNull String messageId, @NotNull String uri) {
        RealmResults<Message> messages = getMessages(messageId);
    ...
    public RealmResults<Status> getStatuses(String userId) {
        return realm.where(Status.class).equalTo(DBConstants.statusId, userId).findAll();
    }
