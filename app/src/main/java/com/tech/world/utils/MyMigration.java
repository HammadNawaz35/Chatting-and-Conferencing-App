...
public class MyMigration implements RealmMigration {
    ...
    public void migrate(DynamicRealm realm, long oldVersion, long newVersion) {
        ...
        if (oldVersion == 7 || oldVersion == 6) {
            ...
            schema.get("Message")
                    .addField(DBConstants.ENCRYPTION_TYPE, String.class)
                    .addField(DBConstants.PARTIAL_TEXT, String.class)
                    .addRealmListField("broadcastUids", String.class);
            ...
            schema.get("RealmContact")
                    .addField("jsonString", String.class);

            schema.get("RealmLocation")
                    .addField("latStr", String.class)
                    .addField("lngStr", String.class);

            schema.create("TempMessage")
                    .addField(DBConstants.MESSAGE_ID, String.class, FieldAttribute.INDEXED)
                    .addField(DBConstants.FROM_ID, String.class)
                    .addField("fromPhone", String.class)
                    .addField(DBConstants.TOID, String.class)
                    .addField(DBConstants.TYPE, int.class)
                    .addField(DBConstants.CONTENT, String.class)
                    .addField(DBConstants.TIMESTAMP, String.class)
                    .addField(DBConstants.THUMB, String.class)
                    .addField(DBConstants.FILESIZE, String.class)
                    .addField(DBConstants.CHAT_ID, String.class, FieldAttribute.INDEXED)
                    .addField(DBConstants.MESSAGE_STAT, int.class)
                    .addField(DBConstants.LOCAL_PATH, String.class)
                    .addField(DBConstants.DOWNLOAD_UPLOAD_STAT, int.class)
                    .addField(DBConstants.METADATA, String.class)
                    .addField("voiceMessageSeen", boolean.class)
                    .addField(DBConstants.MEDIADURATION, String.class)
                    .addField("isForwarded", boolean.class)
                    .addField("videoThumb", String.class)
                    .addField("isGroup", boolean.class)
                    .addField("isBroadcast", boolean.class)
                    .addField("isSeen", boolean.class)
                    .addField(DBConstants.ENCRYPTION_TYPE, String.class)
        ...
        if (oldVersion == 8) {
            schema.get("Message").addField("uri", String.class);
            oldVersion++;
        }
    }
}
