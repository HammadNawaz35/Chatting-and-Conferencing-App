...
import com.tech.world.activities.BackupChatActivity;
import com.tech.world.activities.calling.CallingActivity;
import com.tech.world.activities.main.MainActivity;
import com.tech.world.activities.main.messaging.ChatActivity;
import com.tech.world.activities.setup.SetupUserActivity;
import com.tech.world.model.realms.Chat;
import com.tech.world.model.realms.FireCall;
import com.tech.world.model.realms.Message;
import com.tech.world.model.realms.User;
import com.tech.world.receivers.HandleReplyReceiver;
import com.tech.world.receivers.MarkAsReadReceiver;
import com.tech.world.services.CallingService;
...
import static com.tech.world.utils.IntentUtils.NOTIFICATION_ACTION_DECLINE;
import static com.tech.world.utils.MessageTypeHelper.getMessageContent;
    ...
    public NotificationHelper(Context base) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            NotificationChannel backupChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID_BACKUP,
                    NOTIFICATION_CHANNEL_NAME_BACKUP, NotificationManager.IMPORTANCE_DEFAULT);
            ...
            NotificationChannel restoreChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID_RESTORE,
                    NOTIFICATION_CHANNEL_NAME_RESTORE, NotificationManager.IMPORTANCE_DEFAULT);
            ...
            if (last7UnreadMessages.isEmpty()) {
                ...
                for (int i = 0; i < last7UnreadMessages.size(); i++) {
                    ...
                    if (chatHashMap.size() > 1) {
                        String appName = this.getResources().getString(R.string.app_names);
...
//        start chatActivity with the clicked user
    ...
    private NotificationCompat.Action getReplyActionInput(Chat chat) {
        ...
        NotificationCompat.Action replyAction =
                new NotificationCompat.Action.Builder(R.mipmap.ic_launcher_background,
...
//        new NotificationCompat.Action.Builder(android.R.drawable.sym_def_app_icon,
    ...
    public NotificationCompat.Builder createRestoreNotification(int notificationId, int progress) {
        Intent backupChatIntent = new Intent(this, SetupUserActivity.class);
        PendingIntent pi = PendingIntent.getActivity(this, notificationId, backupChatIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID_RESTORE)
                        .setSmallIcon(R.mipmap.ic_launcher_background)
                        .setContentTitle(getString(R.string.restore_in_progress))
                        .setOnlyAlertOnce(true)
                        .setContentIntent(pi)
                        .setProgress(100,progress,false)
                        .setContentText(getString(R.string.restore_in_progress));
    ...
    public NotificationCompat.Builder createRestoreBackupFailedNotification(int notificationId) {
        Intent backupChatIntent = new Intent(this, SetupUserActivity.class);
        PendingIntent pi = PendingIntent.getActivity(this, notificationId, backupChatIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID_RESTORE)
                        .setSmallIcon(R.mipmap.ic_launcher_background)
                        .setContentTitle(getString(R.string.restore_backup_failed))
                        .setOnlyAlertOnce(true)
                        .setContentIntent(pi)
                        .setContentText(getString(R.string.restore_backup_failed));

        return mBuilder;

    }

    public NotificationCompat.Builder createBackupNotification(int notificationId, int progress) {
        Intent backupChatIntent = new Intent(this, BackupChatActivity.class);
        PendingIntent pi = PendingIntent.getActivity(this, notificationId, backupChatIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID_BACKUP)
                        .setSmallIcon(R.mipmap.ic_launcher_background)
                        .setContentTitle(getString(R.string.backup_in_progress))
                        .setOnlyAlertOnce(true)
                        .setContentIntent(pi)
                        .setProgress(100,progress,false)
                        .setContentText(getString(R.string.backup_in_progress));

        return mBuilder;

    }

    public NotificationCompat.Builder createBackupCompletedNotification(int notificationId) {
        Intent backupChatIntent = new Intent(this, BackupChatActivity.class);
        PendingIntent pi = PendingIntent.getActivity(this, notificationId, backupChatIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID_BACKUP)
    ...
    public NotificationCompat.Builder createBackupFailedNotification(int notificationId) {
        Intent backupChatIntent = new Intent(this, BackupChatActivity.class);
        PendingIntent pi = PendingIntent.getActivity(this, notificationId, backupChatIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID_BACKUP)
                        ...
                        .setOnlyAlertOnce(true)
                        .setContentIntent(pi)
                        .setContentText(getString(R.string.backup_failed));
...
//        PendingIntent pendingIntent = PendingIntent.getService(this, PI_REQUEST_CODE_ANSWER, answerIntent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public void fireUserLoggedOutNotification() {
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID_MESSAGES)
                        .setSmallIcon(R.mipmap.ic_launcher_background)
                        .setContentTitle(getString(R.string.logged_out))
                        .setContentText(getString(R.string.logged_in_another_device));


        getManager().notify(loggedOutNotificationId, mBuilder.build());
    }
}
