...
import com.tech.world.extensions.*
import com.tech.world.model.ImageItem
import com.tech.world.model.constants.LastSeenStates
...
//update voice message state as Seen
    ...
    suspend fun saveDeviceId(uid: String) {
        FireConstants.deviceIdRef.child(uid).setValue(DeviceId.id).await()
    }
    ...
    companion object {
        ...
        fun getRef(type: Int, fileName: String?): StorageReference {
            ...
            when (type) {
                ...
                MessageType.SENT_STICKER -> return FireConstants.stickersRef.child(mName)
