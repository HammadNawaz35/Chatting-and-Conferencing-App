...
public class RealmLocation extends RealmObject implements Parcelable {
    ...
    private String name;
    //used when encryption is enabled since we can't encrypt doubles.
    ...
    public RealmLocation(double lat, double lng, String latStr, String lngStr, String address, String name) {
        this.lat = lat;
        this.lng = lng;
        this.address = address;
        this.name = name;
    ...
    public RealmLocation(String address, String name, String latStr, String lngStr) {
        this.address = address;
        this.name = name;
        this.latStr = latStr;
        this.lngStr = lngStr;
    ...
    public HashMap<String, Object> toMap(boolean isEncrypted) {
        HashMap<String, Object> locationMap = new HashMap<>();
        Object newLat = isEncrypted ? latStr : lat;
        Object newLng = isEncrypted ? lngStr : lng;
        locationMap.put("lat", newLat);
        locationMap.put("lng", newLng);
